...
const routes:  (Partial<MenuItemType> & RouteObject) [] = [
  ...
  {path: '/',hideInMenu: false, element: <Layout/>, icon: <BsShop className={style.navIcon}/> , name: '', children: [
      {path: 'stores', element: <Store/>, icon: <BsShop className={style.navIcon}/> , hideInMenu: false, name: '门店管理', children: [ ]},
    ]},
