...
import {createCar, CreateQueryType, destroyCar, fetchCars, updateCar} from "@/api/car";
...
export {createCarHunk, initThunk, fetchThunk, updateCarThunk, deleteThunk}
