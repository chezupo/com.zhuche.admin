...
import InputRender from '@/pages/store/BaseInfor/TableRender/CreateStore/StepFormRender/StoreInformationForm/InputRender';
import BannerInputRender from '@/pages/store/BaseInfor/TableRender/CreateStore/StepFormRender/StoreInformationForm/BannerInputRender';
import { FormInstance } from 'antd/lib/form/hooks/useForm';
import SwitchRender from '@/pages/store/BaseInfor/TableRender/CreateStore/StepFormRender/StoreInformationForm/SwitchRender';
...
export const FormContext =
  React.createContext<FormInstance<CreateStoreType> | null>(null);
...
const StoreInformationForm: React.FC<StoreInformationFormPropsType> = (
  props
) => {
      ...
      >
        <Row gutter={24}>
          ...
          <SwitchRender
            label='高铁站'
            name='isStation'
            rules={{ required: true, message: '高铁站不能为空' }}
          />
          <SwitchRender
            label='含自助车型'
            name='isSelfService'
            rules={{ required: true, message: '自助车型不能为空' }}
          />
